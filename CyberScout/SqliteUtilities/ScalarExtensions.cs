...
public record IntegerScalarResult : ValueResult<long, IntegerScalarError> {
...
public partial class IntegerScalarError : OneOfBase<
	...
	public static implicit operator Error(IntegerScalarError error) {
...
public record NullableIntegerScalarResult : ValueResult<OneOf<long, None>, NullableIntegerScalarError> {
...
public partial class NullableIntegerScalarError : OneOfBase<
	...
	public static implicit operator Error(NullableIntegerScalarError error) {
...
public record RealScalarResult : ValueResult<double, RealScalarError> {
...
public partial class RealScalarError : OneOfBase<
	...
	public static implicit operator Error(RealScalarError error) {
...
public record NullableRealScalarResult : ValueResult<OneOf<double, None>, NullableRealScalarError> {
...
public partial class NullableRealScalarError : OneOfBase<
	...
	public static implicit operator Error(NullableRealScalarError error) {
...
public record TextScalarResult : Result<string, TextScalarError> {
...
public partial class TextScalarError : OneOfBase<
	...
	public static implicit operator Error(TextScalarError error) {
...
public record NullableTextScalarResult : ValueResult<OneOf<string, None>, NullableTextScalarError> {
...
public partial class NullableTextScalarError : OneOfBase<
	...
	public static implicit operator Error(NullableTextScalarError error) {
...
public record BlobScalarResult : Result<byte[], BlobScalarError> {
...
public partial class BlobScalarError : OneOfBase<
	...
	public static implicit operator Error(BlobScalarError error) {
...
public record NullableBlobScalarResult : ValueResult<OneOf<byte[], None>, NullableBlobScalarError> {
...
public partial class NullableBlobScalarError : OneOfBase<
	...
	public static implicit operator Error(NullableBlobScalarError error) {
